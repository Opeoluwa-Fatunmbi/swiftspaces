...
# SETTINGS = config("SETTINGS", default=f"swiftspaces.settings.{config('SETTINGS')}")
...
LOCAL_APPS = ["apps.common", "apps.accounts", "apps.properties", "apps.general"]
...
WSGI_APPLICATION = "swiftspaces.wsgi.application"
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "SwiftSpaces",
    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "SwiftSpaces ADMIN",
    ...
    "welcome_sign": "Welcome to SwiftSpaces Admin Section",
    # Copyright on the footer
    "copyright": "swiftspaces Ltd",
    ...
    "usermenu_links": [
        {"name": "SwiftSpaces FrontPage", "url": "/", "new_window": True},
        {"model": "accounts.user"},
    ],
    #############
    # Side Menu #
...
ASGI_APPLICATION = "swiftspaces.asgi.application"
